...
import { ComparisonTableTool } from "@/components/assistant-ui/comparison-table";
      ...
      <div className="aui-thread-welcome-center flex w-full grow flex-col items-center justify-center">
        <div className="aui-thread-welcome-message flex size-full flex-col justify-center px-4">
          ...
          <p className="aui-thread-welcome-message-inner fade-in slide-in-from-bottom-1 animate-in fill-mode-both text-muted-foreground text-xl delay-75 duration-200">
            I am your medical benefit drug policy assistant. Ask me anything about policies, limits, and criteria.
          </p>
        </div>
      </div>
      <ThreadSuggestions />
        ...
        <MessagePrimitive.Parts>
          {({ part }) => {
            ...
            if (part.type === "tool-call") {
              if (part.toolName === "compare_drug_between_payers") {
                return <ComparisonTableTool key={part.toolCallId} {...part} />;
              }
